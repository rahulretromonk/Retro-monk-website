...
//     const validRating = typeof rating === 'number' && rating >= 1 && rating <= 5 ? rating : 5;
//     return (
...
//             key={i}
//             size={14}
//             className={i < validRating ? "fill-[#a88655] text-[#a88655]" : "text-[#E8DCCB]"}
//           />
//         ))}
//       </div>
//     );
...
//                     {item.clientName}
//                   </h3>
//                   <span className="text-[10px] tracking-wider text-[#a88655] font-semibold uppercase mb-2 block">
...
//                 {renderStars(activeModalItem.rating)}
